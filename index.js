...
app.post('/api/account', (req, res) => {
  ...
  if(req.body.bot_running !== undefined)
    botSettings.running = req.body.bot_running;
  res.json({ status: 'ok' });
});

// MT5 henter ventende kommandoer hvert 5. sekund
...
// MT5 sender resultat af kommando
